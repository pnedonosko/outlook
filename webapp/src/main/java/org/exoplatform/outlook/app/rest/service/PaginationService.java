...
public class PaginationService {
   ...
   * @param activitiesNumber the activities number
   * @return the pagination metadata
   */
  public PagedResources.PageMetadata getPaginationMetadata(Integer offset, Integer limit, int activitiesNumber) {
